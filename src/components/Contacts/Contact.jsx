...
const Contact = () => {
  return (
    <footer id="contacts" className='text-main mt-120px bg-[rgb(126,39,20)] flex flex-row justify-evenly w-[100vw] py-[58px] px-[10%] gap-[10px] md:flex-col md:gap-[23px] font-["Montserrat"]'>
        <div className='text-[80px] font-extraboldbold space-[2px] md:flex md:flex-col md:items-center'>
            <h2 className='text-[70px] font-bold space-[4px]'>Contact</h2>
            <p className='text-[35px] font-semibold space-[4px]'>Feel free to reach out!</p>
        </div>
