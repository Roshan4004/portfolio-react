...
const Intro = () => {
  return (
    <>
      <section className={`2xl:relative 2xl:flex 2xl:items-center 2xl:justify-between 2xl:mt-[49px] 2xl:z-[1] 2xl:mx-[10%] md:flex-col-reverse`}>
        <div className={`2xl:flex 2xl:flex-col 2xl:items-start 2xl:text-main 2xl:z-[1] md:items-center`}>
        ...
        <img className={`2xl:w-[30vh] 2xl:z-[1] 2xl:animate-floating-image md:w-[20vh]`} src={getImageUrl("intro/myimg.png")} alt="myimage"></img>
      </section>
    </>
  )
}
